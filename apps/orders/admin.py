...
class OrderItemInline(admin.TabularInline):
    ...
    extra = 0
    readonly_fields = (
    'product', 'product_name', 'variant', 'variant_name', 'sku', 'unit_price', 'quantity', 'total_price')
    can_delete = False
...
class OrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Shipping Information', {
            'fields': ('address', 'city', 'state', 'postal_code', 'country', 'shipping_method', 'shipping_price',
                       'tracking_number')
        }),
        ('Order Details', {
